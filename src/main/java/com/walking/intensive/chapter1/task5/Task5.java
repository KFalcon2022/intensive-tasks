...
//        Для собственных проверок можете делать любые изменения в этом методе
        ...
        System.out.println("Треугольник существует: " + !isTriangleNotExist(a, b, c) +
                "\nПлощадь по формуле Герона:  " + getAreaByHeron(a, b, c) +
    ...
    static double getAreaByHeron(double a, double b, double c) throws IllegalArgumentException {
