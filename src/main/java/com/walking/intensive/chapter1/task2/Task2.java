...
//        System.out.println(flatLocation);
    ...
    static String getFlatLocation(int floorAmount, int entranceAmount, int flatNumber) {
        ...
        if ((flatNumber < 1) || (flatNumber > floorAmount * entranceAmount * flatsOnFloorAmmount))
        {
            ...
            result = flatNumber + " кв - " + entranceNumber + " подъезд, " + floorNumber;
            switch (flatNumber - (floorAmount * flatsOnFloorAmmount * (entranceNumber - 1))- (floorNumber - 1) * flatsOnFloorAmmount){
                case 1: result = result + " этаж, слева от лифта, влево";
                    break;
                case 2: result = result + " этаж, слева от лифта, вправо";
                    break;
                case 3: result = result + " этаж, справа от лифта, влево";
                    break;
                case 4: result = result + " этаж, справа от лифта, вправо";
                    break;
            }
