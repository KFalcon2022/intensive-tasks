...
public class Task2 {
    ...
    static String getFlatLocation(int floorAmount, int entranceAmount, int flatNumber) {
        ...
        return switch (flatNumber % 4) {
            ...
            default ->
                    "Ошибка"; // !Вопрос! Написал "default", т.к. компилятор переживал что switch покрывает не все возможные значения и не будет return. Как-то можно иначе это реализовать? Ведь, по факту, switch покрывает все возможные значения.
        };
    }
}
